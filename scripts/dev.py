...
class KafkaAgent:
    ...
    def on_before_message(self, *args, **kwargs):
        pass

    def on_after_message(self, *args, **kwargs):
        pass
...
#         self.application = application or BaseApp
#         self.consumer_config = self.config.get("consumer", {})
#         self.producer_config = self.config.get("producer", {})
